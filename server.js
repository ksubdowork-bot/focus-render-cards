...
const personas = {
  p1: {
    ...
    description:
      "핵심 가치 : Life Maximizers,  Enthusiastic about latest technology and find creative ways to work, 매일 오전러닝을 하며, 건간관리 및 외모 및 스타일을 중요하게 생각함, 혁신 추구자: 새 아이디어·스마트 디자인에 강하게 반응, 워라벨 지향: 디지털–피지컬 연결은 탐구하되, 삶과 일의 경계는 명확히 설정, 리스크테이커: 창업가적·충동적 시도, 빠른 모드 전환, 몰입 사용자: 앱·포커스 모드·단축어 자동화로 최적화된 생활 리듬 유지
      
      "일주일의 라이프 스타일 월요일 (출장 도착·준비) :	호텔 러닝 + 헬스 시차 체크 / Notes 아젠다 기록	FaceTime 본사 킥오프 / Safari 현지 리서치 / Notion 미팅 메모	Keynote 발표 초안 검토 / FaceTime 본사 보고 / 포커스 모드 / 저널 기록"
      
      
  },
  p2: {
    id: "p2",
    name: "Social Expressers",
    role: "iPhone15 Pro",
